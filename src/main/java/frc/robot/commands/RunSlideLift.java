...
public class RunSlideLift extends CommandBase {
   private final static Logger logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);
   private final LiftSubsystem Slidelift;
   private double slide;
  // private double raise;
   private double deadband;
   private double maxPower;

   public RunSlideLift(LiftSubsystem subsystem)
   {
      Slidelift = subsystem;
   ...
   public void execute()
   {
      ...
      Slidelift.runSlideLiftMotor(slide);
   }

...
{
    public StartShooterCommandGroup(BallShooterSubsystem ballShooter, BallFeederSubsystem ballFeeder, BallCollectorSubsystem ballCollector, double lowerPower, double upperPower, double servoPosition)
    {
        ...
        (
            ...
            new RunServo(ballShooter, servoPosition),
            new WaitCommand(0.5),

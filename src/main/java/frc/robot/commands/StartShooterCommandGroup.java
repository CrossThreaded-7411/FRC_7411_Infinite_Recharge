...
{
    public StartShooterCommandGroup(BallShooterSubsystem ballShooter, BallFeederSubsystem ballFeeder, BallCollectorSubsystem ballCollector, DribbleSubsystem dribbleMode, double lowerPower, double upperPower)
    {
